              ...
              <div className="relative transform overflow-hidden rounded-2xl text-left sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className="bg-slate-600 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    onClick={close}
                    type="button"
                    className="mt-3 inline-flex w-full justify-center rounded-md bg-orange-800 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                  >
                    {buttonbody2}
                  </button>
                </div>
